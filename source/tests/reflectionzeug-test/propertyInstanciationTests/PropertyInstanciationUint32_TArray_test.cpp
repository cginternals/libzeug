...
TEST_F(PropertyInstanceUint32_TArray_test, instanciatePropertyWith_String_LambdaGetter_LambdaSetter)
{
    ...
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", get, set);

    ASSERT_EQ(typeid(std::array<uint32_t, 0>), prop->type());
...
{
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", &staticGetter, &staticSetter);
...
TEST_F(PropertyInstanceUint32_TArray_test, instanciatePropertyWith_String_Object_ConstGetterConst_SetterConst)
{
    ...
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", obj, &MyObject<uint32_t>::arrayConstgetterconst, &MyObject<uint32_t>::arraySetterconst);
...
{
    auto obj = new MyObject<uint32_t>;
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", obj, &MyObject<uint32_t>::arrayGetterconst, &MyObject<uint32_t>::arraySetterconst);
...
{
    auto obj = new MyObject<uint32_t>;
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", obj, &MyObject<uint32_t>::arrayGetterconst, &MyObject<uint32_t>::arraySetter);
...
TEST_F(PropertyInstanceUint32_TArray_test, instanciateConstPropertyWith_String_LambdaGetter)
{
    ...
    auto prop = new PropertyArray<const uint32_t, 0>("uint32_tProperty", get);
...
{
    auto prop = new PropertyArray<const uint32_t, 0>("uint32_tProperty", &staticGetter);
...
{
    auto obj = new MyObject<uint32_t>;
    auto prop = new PropertyArray<const uint32_t, 0>("uint32_tProperty", obj, &MyObject<uint32_t>::arrayConstgetterconst);
...
{
    auto obj = new MyObject<uint32_t>;
    auto prop = new PropertyArray<const uint32_t, 0>("uint32_tProperty", obj, &MyObject<uint32_t>::arrayGetterconst);
...
{
    auto accessor = new ArrayAccessorValue<uint32_t, 0>();
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorValue<uint32_t, 0>(std::array<uint32_t, 0>());
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", accessor);
...
TEST_F(PropertyInstanceUint32_TArray_test, instanciateAccessorWith_String_LambdaGetter_LambdaSetter)
{
    auto get = [] (size_t) {return uint32_t();};
    auto set = [] (size_t, const uint32_t & val) {};
    auto accessor = new ArrayAccessorGetSet<uint32_t, 0>(get, set);
...
{
    auto accessor = new ArrayAccessorGetSet<uint32_t, 0>(&staticGetter, &staticSetter);
...
{
    auto obj = new MyObject<uint32_t>;
    auto accessor = new ArrayAccessorGetSet<uint32_t, 0>(obj, &MyObject<uint32_t>::arrayConstgetterconst, &MyObject<uint32_t>::arraySetterconst);
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", accessor);
...
{
    auto obj = new MyObject<uint32_t>;
    auto accessor = new ArrayAccessorGetSet<uint32_t, 0>(obj, &MyObject<uint32_t>::arrayGetterconst, &MyObject<uint32_t>::arraySetterconst);
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", accessor);
...
{
    auto obj = new MyObject<uint32_t>;
    auto accessor = new ArrayAccessorGetSet<uint32_t, 0>(obj, &MyObject<uint32_t>::arrayGetterconst, &MyObject<uint32_t>::arraySetter);
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorValue<const uint32_t, 0>();
    auto prop = new PropertyArray<const uint32_t, 0>("uint32_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorValue<const uint32_t, 0>(std::array<uint32_t, 0>());
    auto prop = new PropertyArray<uint32_t, 0>("uint32_tProperty", accessor);
...
{
    auto get = [] (size_t) {return uint32_t();};
    auto accessor = new ArrayAccessorGetSet<const uint32_t, 0>(get);
...
{
    auto accessor = new ArrayAccessorGetSet<const uint32_t, 0>(&staticGetter);
...
{
    auto obj = new MyObject<uint32_t>;
    auto accessor = new ArrayAccessorGetSet<const uint32_t, 0>(obj, &MyObject<uint32_t>::arrayConstgetterconst);
    auto prop = new PropertyArray<const uint32_t, 0>("uint32_tProperty", accessor);
...
{
    auto obj = new MyObject<uint32_t>;
    auto accessor = new ArrayAccessorGetSet<const uint32_t, 0>(obj, &MyObject<uint32_t>::arrayGetterconst);
    auto prop = new PropertyArray<const uint32_t, 0>("uint32_tProperty", accessor);

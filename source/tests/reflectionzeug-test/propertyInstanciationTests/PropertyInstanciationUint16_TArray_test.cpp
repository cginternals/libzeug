...
TEST_F(PropertyInstanceUint16_TArray_test, instanciatePropertyWith_String_LambdaGetter_LambdaSetter)
{
    ...
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", get, set);

    ASSERT_EQ(typeid(std::array<uint16_t, 0>), prop->type());
...
{
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", &staticGetter, &staticSetter);
...
TEST_F(PropertyInstanceUint16_TArray_test, instanciatePropertyWith_String_Object_ConstGetterConst_SetterConst)
{
    ...
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", obj, &MyObject<uint16_t>::arrayConstgetterconst, &MyObject<uint16_t>::arraySetterconst);
...
{
    auto obj = new MyObject<uint16_t>;
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", obj, &MyObject<uint16_t>::arrayGetterconst, &MyObject<uint16_t>::arraySetterconst);
...
{
    auto obj = new MyObject<uint16_t>;
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", obj, &MyObject<uint16_t>::arrayGetterconst, &MyObject<uint16_t>::arraySetter);
...
TEST_F(PropertyInstanceUint16_TArray_test, instanciateConstPropertyWith_String_LambdaGetter)
{
    ...
    auto prop = new PropertyArray<const uint16_t, 0>("uint16_tProperty", get);
...
{
    auto prop = new PropertyArray<const uint16_t, 0>("uint16_tProperty", &staticGetter);
...
{
    auto obj = new MyObject<uint16_t>;
    auto prop = new PropertyArray<const uint16_t, 0>("uint16_tProperty", obj, &MyObject<uint16_t>::arrayConstgetterconst);
...
{
    auto obj = new MyObject<uint16_t>;
    auto prop = new PropertyArray<const uint16_t, 0>("uint16_tProperty", obj, &MyObject<uint16_t>::arrayGetterconst);
...
{
    auto accessor = new ArrayAccessorValue<uint16_t, 0>();
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorValue<uint16_t, 0>(std::array<uint16_t, 0>());
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", accessor);
...
TEST_F(PropertyInstanceUint16_TArray_test, instanciateAccessorWith_String_LambdaGetter_LambdaSetter)
{
    auto get = [] (size_t) {return uint16_t();};
    auto set = [] (size_t, const uint16_t & val) {};
    auto accessor = new ArrayAccessorGetSet<uint16_t, 0>(get, set);
...
{
    auto accessor = new ArrayAccessorGetSet<uint16_t, 0>(&staticGetter, &staticSetter);
...
{
    auto obj = new MyObject<uint16_t>;
    auto accessor = new ArrayAccessorGetSet<uint16_t, 0>(obj, &MyObject<uint16_t>::arrayConstgetterconst, &MyObject<uint16_t>::arraySetterconst);
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", accessor);
...
{
    auto obj = new MyObject<uint16_t>;
    auto accessor = new ArrayAccessorGetSet<uint16_t, 0>(obj, &MyObject<uint16_t>::arrayGetterconst, &MyObject<uint16_t>::arraySetterconst);
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", accessor);
...
{
    auto obj = new MyObject<uint16_t>;
    auto accessor = new ArrayAccessorGetSet<uint16_t, 0>(obj, &MyObject<uint16_t>::arrayGetterconst, &MyObject<uint16_t>::arraySetter);
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorValue<const uint16_t, 0>();
    auto prop = new PropertyArray<const uint16_t, 0>("uint16_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorValue<const uint16_t, 0>(std::array<uint16_t, 0>());
    auto prop = new PropertyArray<uint16_t, 0>("uint16_tProperty", accessor);
...
{
    auto get = [] (size_t) {return uint16_t();};
    auto accessor = new ArrayAccessorGetSet<const uint16_t, 0>(get);
...
{
    auto accessor = new ArrayAccessorGetSet<const uint16_t, 0>(&staticGetter);
...
{
    auto obj = new MyObject<uint16_t>;
    auto accessor = new ArrayAccessorGetSet<const uint16_t, 0>(obj, &MyObject<uint16_t>::arrayConstgetterconst);
    auto prop = new PropertyArray<const uint16_t, 0>("uint16_tProperty", accessor);
...
{
    auto obj = new MyObject<uint16_t>;
    auto accessor = new ArrayAccessorGetSet<const uint16_t, 0>(obj, &MyObject<uint16_t>::arrayGetterconst);
    auto prop = new PropertyArray<const uint16_t, 0>("uint16_tProperty", accessor);

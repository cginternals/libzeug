...
TEST_F(PropertyInstanceInt64_T_test, instanciateConstPropertyWith_String_LambdaGetter_LambdaSetter)
{
    auto get = [] () {return 0;};
...
TEST_F(PropertyInstanceInt64_T_test, instanciateConstPropertyWith_String_Object_ConstGetterConst_SetterConst)
{
    auto obj = new MyObject<int64_t>;
...
TEST_F(PropertyInstanceInt64_T_test, instanciateConstPropertyWith_String_Object_GetterConst_SetterConst)
{
    auto obj = new MyObject<int64_t>;
...
{
    auto accessor = new AccessorValue<int64_t>(0);
    auto prop = new Property<int64_t>("int64_tProperty", accessor);
...
{
    auto accessor = new AccessorValue<const int64_t>(0);
    auto prop = new Property<int64_t>("int64_tProperty", accessor);
...
TEST_F(PropertyInstanceInt64_T_test, instanciateConstAccessorWith_String_LambdaGetter_LambdaSetter)
{
    auto get = [] () {return 0;};
...
TEST_F(PropertyInstanceInt64_T_test, instanciateConstAccessorWith_String_Object_ConstGetterConst_SetterConst)
{
    auto obj = new MyObject<int64_t>;
...
TEST_F(PropertyInstanceInt64_T_test, instanciateConstAccessorWith_String_Object_GetterConst_SetterConst)
{
    auto obj = new MyObject<int64_t>;

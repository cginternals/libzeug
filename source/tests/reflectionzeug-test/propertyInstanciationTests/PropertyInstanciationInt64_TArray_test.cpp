...
TEST_F(PropertyInstanceInt64_TArray_test, instanciatePropertyWith_String_LambdaGetter_LambdaSetter)
{
    ...
    ASSERT_EQ(typeid(std::array<int64_t, 1>), prop->type());
...
{
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", &staticGetter, &staticSetter);
...
TEST_F(PropertyInstanceInt64_TArray_test, instanciatePropertyWith_String_Object_ConstGetterConst_SetterConst)
{
    ...
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", obj, &MyObject<int64_t>::arrayConstgetterconst, &MyObject<int64_t>::arraySetterconst);
...
{
    auto obj = new MyObject<int64_t>;
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", obj, &MyObject<int64_t>::arrayGetterconst, &MyObject<int64_t>::arraySetterconst);
...
{
    auto obj = new MyObject<int64_t>;
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", obj, &MyObject<int64_t>::arrayGetterconst, &MyObject<int64_t>::arraySetter);
...
TEST_F(PropertyInstanceInt64_TArray_test, instanciateConstPropertyWith_String_LambdaGetter)
{
    ...
    auto prop = new PropertyArray<const int64_t, 1>("int64_tProperty", get);
...
{
    auto prop = new PropertyArray<const int64_t, 1>("int64_tProperty", &staticGetter);
...
{
    auto obj = new MyObject<int64_t>;
    auto prop = new PropertyArray<const int64_t, 1>("int64_tProperty", obj, &MyObject<int64_t>::arrayConstgetterconst);
...
{
    auto obj = new MyObject<int64_t>;
    auto prop = new PropertyArray<const int64_t, 1>("int64_tProperty", obj, &MyObject<int64_t>::arrayGetterconst);
...
{
    auto accessor = new ArrayAccessorValue<int64_t, 1>();
...
{
    auto accessor = new ArrayAccessorValue<int64_t, 1>(std::array<int64_t, 1>());
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorGetSet<int64_t, 1>(&staticGetter, &staticSetter);
...
{
    auto obj = new MyObject<int64_t>;
    auto accessor = new ArrayAccessorGetSet<int64_t, 1>(obj, &MyObject<int64_t>::arrayConstgetterconst, &MyObject<int64_t>::arraySetterconst);
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", accessor);
...
{
    auto obj = new MyObject<int64_t>;
    auto accessor = new ArrayAccessorGetSet<int64_t, 1>(obj, &MyObject<int64_t>::arrayGetterconst, &MyObject<int64_t>::arraySetterconst);
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", accessor);
...
{
    auto obj = new MyObject<int64_t>;
    auto accessor = new ArrayAccessorGetSet<int64_t, 1>(obj, &MyObject<int64_t>::arrayGetterconst, &MyObject<int64_t>::arraySetter);
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorValue<const int64_t, 1>();
    auto prop = new PropertyArray<const int64_t, 1>("int64_tProperty", accessor);
...
{
    auto accessor = new ArrayAccessorValue<const int64_t, 1>(std::array<int64_t, 1>());
    auto prop = new PropertyArray<int64_t, 1>("int64_tProperty", accessor);
...
{
    auto get = [] (size_t) {return int64_t();};
    auto accessor = new ArrayAccessorGetSet<const int64_t, 1>(get);
...
{
    auto accessor = new ArrayAccessorGetSet<const int64_t, 1>(&staticGetter);
...
{
    auto obj = new MyObject<int64_t>;
    auto accessor = new ArrayAccessorGetSet<const int64_t, 1>(obj, &MyObject<int64_t>::arrayConstgetterconst);
    auto prop = new PropertyArray<const int64_t, 1>("int64_tProperty", accessor);
...
{
    auto obj = new MyObject<int64_t>;
    auto accessor = new ArrayAccessorGetSet<const int64_t, 1>(obj, &MyObject<int64_t>::arrayGetterconst);
    auto prop = new PropertyArray<const int64_t, 1>("int64_tProperty", accessor);

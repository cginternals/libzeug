...
LOGGINGZEUG_API int readInt(const char* str, int& number);
LOGGINGZEUG_API void parseFormat(std::ostream& stream, const char*& format);

LOGGINGZEUG_API void streamprintf(std::ostream& stream, const char* format);
...
#include <loggingzeug/formatString.hpp>
